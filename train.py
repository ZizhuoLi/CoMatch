...
def parse_args():
    ...
    parser.add_argument(
        '--train_coarse_percent', type=float, default=0.3, help='training tricks: save GPU memory')
    parser.add_argument(
...
def main():
    ...
    if args.train_coarse_percent is not None:
        config.TRAIN_COARSE_PERCENT = args.train_coarse_percent
    if args.disable_mp:
